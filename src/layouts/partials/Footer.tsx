...
const Footer = ({
  ...
  return (
    <footer
      className={`bg-theme-light dark:bg-darkmode-theme-light ${isRtl && "rtl"}`}
    >
      <div className="container">
        <div className="row items-center py-10">
          ...
          <div className="mb-8 text-center lg:col-6 lg:mb-0">
            <ul>
              {menu.footer.map((menu, i) => (
                <li
                  className={`m-3 inline-block ${isRtl && i === 0 && "mr-0"}`}
                  key={menu.name}
                >
          ...
          <div
            className={`mb-8 text-center lg:col-3 lg:mb-0 lg:mt-0 ${isRtl ? "lg:text-left" : "lg:text-right"}`}
          >
